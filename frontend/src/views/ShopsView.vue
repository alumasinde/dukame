...
<template>
  <div class="page-stack">
    ...
    <div class="shop-layout">
      <section class="panel">
        <div class="panel-heading"><div><h3>New business</h3></div></div>
      ...
      <section class="panel">
        <div class="panel-heading"><div><h3>Your businesses</h3></div></div>
        <div v-if="!shops.length" class="mini-empty">No businesses yet.</div>
        <button v-for="shop in shops" :key="shop.public_id" class="shop-row" :class="{ selected: shop.public_id === auth.activeTenantId }" @click="auth.setActiveTenant(shop.public_id)">
