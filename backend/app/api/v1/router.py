...
from app.modules.catalogue.routes import (
    categories_router,
    inventory_router,
    media_router,
    options_router,
...
from app.modules.commerce.routes import (
    delivery_router,
    orders_router,
    payments_router,
...
from app.modules.subscriptions.routes import public_pricing_router, subscriptions_router
...
api_router.include_router(public_pricing_router)
